							...
							<div class="top-cart-icons float-end">
								<nav class="navbar navbar-expand">
									<ul class="navbar-nav ms-auto">
										<li class="nav-item"><a href="account-dashboard.php" class="nav-link cart-link"><i class='bx bx-user'></i></a>
										</li>
					...
					<nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item dropdown">	<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">Shop  <i class='bx bx-chevron-down'></i></a>
                                ...
                                </i><a class="dropdown-item" href="shop-grid-right-sidebar.php">Product</a>
							...
							<li class="nav-item"> <a class="nav-link" href="blog.php">Artikel </a> 
                            </li>
							<li class="nav-item"> <a class="nav-link" href="shop-categories.php">Forum diskusi</a> 
                            </li>
							...
							<li class="nav-item dropdown">	<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">My Account  <i class='bx bx-chevron-down'></i></a>
								<ul class="dropdown-menu">
									<li><a class="drom" pdown-itehref="account-dashboard.php">Dashboard</a>
									</li>
