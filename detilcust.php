								...
								<div class="row">
									...
									<div class="col-lg-8">
										<div class="card shadow-none mb-0 border">
											<div class="card-body">
												<form action="datacust.php" method="post" enctype="multipart/form-data">
													<div class="col-md-6">
													...
													<div class="col-12">
														...
														<input type="text" name="nohp" id="nohp">													</div>
													<div class="col-12">
													...
													<div class="mb-3 row">
														<label for="kategori" class="col-sm-2 col-form-label">Jenis Kelamin</label>
														<div class="col-sm-10">
